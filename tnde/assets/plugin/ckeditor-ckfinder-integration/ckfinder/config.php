...
*/
$baseUrl = 'http://tnde.uinbanten.ac.id/assets/upload/';
//$baseUrl = 'http://tnde.uinbanten.ac.id/assets/plugin/ckeditor-ckfinder-integration/ckfinder/core/connector/php/assets/upload/';
$enabled = true;
/*
