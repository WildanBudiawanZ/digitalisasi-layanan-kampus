...
//          format: 'H:mm',    // use this format if you want the 24hours timepicker
    ...
    showSwal: function(type,id_tiket){
        ...
        if(type == 'basic'){
            ...
            swal({
                    title: 'Terima Tiket?',
                    text: "Pilih terima untuk memproses tiket",
                    type: 'warning',
                  ...
                  swal({
                    ...
                    text: 'Silahkan proses tiket.',
                    type: 'success',
                    confirmButtonClass: "btn btn-success",
                    buttonsStyling: false
                    }).then(function() {
                        window.location = "StatusTiket3/"+id_tiket;
                    });
                });
            }else if(type == 'warning-message-and-confirmation-verification'){
            event.preventDefault();
            swal({
                    title: 'Verifikasi Pekerjaan?',
                    text: "Pilih verifikasi untuk memproses bahwa pekerjaan sudah selesai (100 %)",
                    type: 'warning',
                    showCancelButton: true,
                    confirmButtonClass: 'btn btn-success',
                    cancelButtonClass: 'btn btn-danger',
                  ...
                  swal({
                    ...
                    buttonsStyling: false
                        ...
                        window.location = "StatusTiket5/"+id_tiket;
                    });
                });
            ...
            swal({
                    title: 'Terima Tiket ?',
                    text: 'Pilih Setuju jika ingin menyetujui tiket yang telah diajukan',
                    type: 'warning',
                    showCancelButton: true,
                  ...
                  swal({
                    ...
                    text: 'Tiket akan diberikan ke pada staff yang menangani',
                    type: 'success',
                    confirmButtonClass: "btn btn-success",
                    buttonsStyling: false
                    }).then(function() {
                        window.location = "StatusTiket1/"+id_tiket;
                    });
                }, function(dismiss) {
                  ...
                  if (dismiss == 'cancel') {
                    swal({
                      title: 'Tiket Ditolak',
                      text: 'Tiket telah ditolak :)',
                      type: 'error',
                      confirmButtonClass: "btn btn-info",
                      buttonsStyling: false,
                    }).then(function() {
                        window.location = "StatusTiket2/"+id_tiket;
                    });
                  }
                })
